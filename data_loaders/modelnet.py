...
import data_loaders.transforms as Transforms
...
def get_train_datasets(args: argparse.Namespace):
    ...
    train_transforms, val_transforms = get_transforms(args.noise_type, args.max_angle, args.max_trans,
...
def get_test_datasets(args: argparse.Namespace):
    ...
    _, test_transforms = get_transforms(args.noise_type, args.max_angle, args.max_trans,
                                        args.n_points, args.partial)
